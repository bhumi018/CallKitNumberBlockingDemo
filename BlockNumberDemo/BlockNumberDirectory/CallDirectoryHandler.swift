...
//        }
    ...
    private func addBlockingPhoneNumbers(to context: CXCallDirectoryExtensionContext) throws {
        if !self.getBlockedContacts().isEmpty{
            let numbers = self.getBlockedContacts()
    ...
    func getBlockedContacts() -> [String] {
        let defaults = UserDefaults(suiteName: "group.com.BlockNumberDemo")
